import { CommonShapes } from "../Basic/CommonShapes";
import { Shader, ShaderProgram, ShaderType } from "./ShaderProgram";
...
export class DrawTextureProgram {
    ...
    constructor(gl: WebGLRenderingContext) {
        this.gl = gl;
        const screenDrawMesh = new CommonShapes.ScreenSpaceRectangle();

        const vertexShader = new Shader(gl, ShaderType.VERTEX, DrawTextureProgram.ScreenDrawVertexShader);
        const pixelShader = new Shader(gl, ShaderType.PIXEL, DrawTextureProgram.ScreenDrawPixelShader);
        ...
        gl.bufferData(gl.ARRAY_BUFFER, screenDrawMesh.uv, gl.STATIC_DRAW);
